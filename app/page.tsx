  ...
  return (
    <main className="min-h-screen relative" style={{ background: '#0A0812' }}>
      ...
      <div className="relative" style={{ zIndex: 10 }}>
        ...
        <section className="h-screen pt-24 relative" style={{ background: 'radial-gradient(circle at 60% 40%, rgba(108, 31, 255, 0.25), transparent 70%)' }}>
          <BentoGrid onAllAnimationsComplete={handleAllAnimationsComplete} />
        </section>

        {/* About Section */}
        <section id="about" className="min-h-screen px-8 py-16 flex items-center justify-center relative" style={{ backgroundColor: 'transparent' }}>
          <div className="max-w-7xl mx-auto w-full text-center">
            <h2 className="text-4xl font-bold mb-12" style={{ color: '#FFFFFF' }}>About Me</h2>
            <div className="grid grid-cols-1 md:grid-cols-5 gap-8 items-center text-left">
              ...
              <div className="md:col-span-3 pl-4">
                <p className="text-lg leading-relaxed mb-4" style={{ color: '#B3A9C9', letterSpacing: '0.3px' }}>
                ...
                <p className="text-lg leading-relaxed mb-4" style={{ color: '#B3A9C9', letterSpacing: '0.3px' }}>
                  I love taking ideas from <span className="font-bold" style={{ color: '#A85CFF' }}>0 → 1</span>, blending technical problem-solving with strategic thinking to turn ambitious concepts into real impact.
                </p>
                <p className="text-lg leading-relaxed mb-4" style={{ color: '#B3A9C9', letterSpacing: '0.3px' }}>
                  My background spans <span className="font-bold" style={{ color: '#A85CFF' }}>software engineering</span>, <span className="font-bold" style={{ color: '#A85CFF' }}>product management</span>, and <span className="font-bold" style={{ color: '#A85CFF' }}>consulting</span>, giving me a toolkit to navigate both the code and the bigger picture.
                </p>
                <p className="text-lg leading-relaxed mb-4" style={{ color: '#B3A9C9', letterSpacing: '0.3px' }}>
                ...
                <p className="text-lg leading-relaxed" style={{ color: '#B3A9C9', letterSpacing: '0.3px' }}>
        ...
        {/* Experience Section */}
        <section id="experience" className="min-h-screen px-8 py-16 pb-48 relative" style={{ backgroundColor: 'transparent' }}>
          <TimelineDemo />
        </section>

        {/* Projects Section */}
        <section id="projects" className="min-h-screen pt-32 relative" style={{ backgroundColor: 'transparent' }}>
          <ProjectsSection />
        </section>
